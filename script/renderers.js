...
//Create large-scale RC Structure Icon Renderer
...
//Create small-scale RC Structure Icon Renderer
 
const verticalOffsetSmall = {
    screenLength: 2.5,
    maxWorldLength: 15,
    minWorldLength: 7.5
};

function getIconSmall(icon) {
  return {
    type: "point-3d", 
    symbolLayers: [
      {
    ...
    verticalOffset: verticalOffsetSmall,
