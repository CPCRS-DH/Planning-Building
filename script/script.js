...
$('#about-close, #nav-close, #img-close').click(function () {
...
imageOnePlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_1.png"}
});
...
imageTwoPlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_2.png"}
});
...
imageThreePlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_3.png"}
});
...
imageFourPlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_4_1.png"}
});
...
imageFivePlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_5.png"}
});
...
imageSixPlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_6_1.png"}
});
...
imageSevenPlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_7_1.png"}
});
...
imageEightPlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_8.png"}
});
...
imageNinePlane.components[0].material = new MeshMaterial({
  colorTexture: {url: "./assets/images/TourImages/Stop_9.png"}
});
...
view.on("immediate-click", (event) => {
  view.hitTest(event).then((hitResult) => {
    if (hitResult.results.length > 0 && hitResult.results[0].graphic.layer.id == "rcStructures" && hitResult.results[0].graphic.attributes.Tour_Building == 1) {
      ...
      let popupCaption = document.querySelector('.popup-text p:first-of-type')
      ...
      modalCaption = popupCaption.innerHTML;

      $('#popup-image-id').attr('data-caption', modalCaption);
...
reactiveUtils.watch(
  ...
  (scale) => {
    ...
    rcStructureIcons.renderer = scale <= 300 ? rcIconRendererSmall : rcIconRenderer;
    rcStructureIcons.labelingInfo = scale <= 300 ? structureUseLabelSmall : structureUseLabel;
    newDealBuildingsLabelPoint.labelingInfo = scale <= 300 ? newDealLabelSmall : newDealLabel;
